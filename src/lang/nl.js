export default {
    ...
    practice: {
        sentences: [
            'wij hebben vanavond lekker gekookt',
            'de koning is naar maastricht geweest om zijn verjaardag te vieren',
            'ik moet een mooi cadeau halen voor hem',
        ],
        subtitle: 'Oefenrondje',
    },
};